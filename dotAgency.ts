...
const userSelect = await select({
  ...
  choices: [
    ...
    {
      name: "Bid .Agency With PriceNonce",
      value: "mintDotAgencyWithPriceNonce",
      description: "Spend ETH to mint .agency to participate",
    },
    {
      name: "Deploy ERC7527",
      value: "deployAppAndAgency",
      description: `Deploy ERC7527. This process can be done after ${chalk.blueBright(
        "Bid .Agency"
      )}`,
    },
    {
...
switch (userSelect) {
  ...
  case "mintDotAgencyWithPriceNonce":
    await mintDotAgencyWithPriceNonce();
    break;
